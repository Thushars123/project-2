...
def find_thinnest_line(image_path):
    ...
    output_file = os.path.join('task 8', 'output_image.jpg')
...
# Load the image
image = cv2.imread('task 8\output_image.jpg')
...
output_file = os.path.join('task 8', 'output_final.jpg')
cv2.imwrite(output_file, rotated_image)

print(f"Output image saved as {output_file}")
ruler_image=cv2.imread(r'task 2\ruler.jpg')
rotated_image=cv2.imread(r'task 2\output_final.jpg')
...
output_file = os.path.join('task 8', 'output_final_image.jpg')
