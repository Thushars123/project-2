...
image_path = 'task10\captured_image_saved\img0.jpg'
def find_thinnest_line(image_path):
    ...
    output_file = os.path.join('task10','output_images', 'captured_image.jpg')
...
# Load the image
image = cv2.imread('task10\output_images\captured_image.jpg')
...
output_file = os.path.join('task10','output_images','captured_rotated_image.jpg')
cv2.imwrite(output_file, rotated_image)

print(f"Output image saved as {output_file}")
ruler_image=cv2.imread(r'task2\ruler.jpg')
rotated_image=cv2.imread(r'task10\output_images\captured_rotated_image.jpg')
...
output_file = os.path.join('task10','output_images','output_final_image.jpg')
...
speech_statement="The focal length is "+str(math.ceil( thinnest_point_value))+"mm"

# Initialize the text-to-speech engine
engine = pyttsx3.init()


print(speech_statement)

# Say the statement
engine.say(speech_statement)
engine.runAndWait()